...
A successful build of Shatterdome also builds the scripting reference, which should be the `script_reference.html` file in the build directory.

To build the reference manually, you must have Python 3 installed.

1. Navigate to the `script_docs` directory in the Shatterdome repository.
